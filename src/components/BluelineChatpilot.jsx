...
export default function BluelineChatpilot() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#f6f7fb] to-white text-gray-900">
      {/* MAIN CONTENT (neemt ruimte, zodat footer onderaan blijft) */}
      <div className="flex-1">
        <div className="mx-auto max-w-[760px] px-3 pt-6 pb-10">
          {/* CARD / PANEL met vaste hoogte zodat header/dock sticky werken */}
          <div className="flex flex-col rounded-2xl border border-gray-200 shadow-lg bg-white h-[78vh]">
            {/* Sticky header binnen de kaart (altijd zichtbaar) */}
